...
export function ProductCard({
  ...
  if (product.active) {
    return (
      <div
        className={`p-10 border-2 hover:cursor-pointer text-white ${
          selectedPlan.plan === product.productId
            ? "-translate-y-2 border-2 border-green-500"
            : "hover:-translate-y-2"
  ...
  return (
    <>
      <div className="flex mb-6 m-auto">
        <div className={`${selectedType.type==='monthly'?'outline outline-1 border-none outline-green-500':''} px-5 py-2 text-white outline outline-1 m-2 hover:cursor-pointer`} onClick={() => selectedType.setType("monthly")}>
          Monthly
        </div>
        <div className={`${selectedType.type==='yearly'?'outline outline-1 border-none outline-green-500':''} px-5 py-2 text-white outline outline-1 m-2 hover:cursor-pointer`} onClick={() => selectedType.setType("yearly")}>
          Yearly
        </div>
      </div>
